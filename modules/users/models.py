...
class UserManager(BaseUserManager, models.Manager):
    ...
    def _create_user(self, email, password, is_active, is_superuser, **extra_fields):
        ...
        user = self.model(email=email, is_active=is_active, is_superuser=is_superuser, **extra_fields)
    ...
    def create_superuser(self, email, password, **extra_fields):
        ...
        return self._create_user(email, password, True, True, is_staff=True, ** extra_fields)
